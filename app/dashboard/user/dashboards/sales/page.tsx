  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">This is a placeholder for the Power BI Sales Dashboard integration.</p>
      </div>
        ...
        <CardContent className="flex items-center justify-center p-6">
          <div className="text-center">
            ...
            <div className="h-[400px] w-full bg-muted rounded-lg flex items-center justify-center">
              <p className="text-muted-foreground">Sales Dashboard Placeholder</p>
            </div>
          </div>
        </CardContent>
      </Card>
